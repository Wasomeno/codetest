export interface AppProject {
  ...
  /** GitLab numeric project ids (present on medium+ API responses). */
  issueRepoId?: number;
  specsRepoId?: number;
  ...
  /** Path-with-namespace of the GitLab repo that hosts this project's backend code. */
  backendRepoName: string;
  /** Path-with-namespace of the GitLab repo that hosts this project's frontend code. */
